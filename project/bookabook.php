  ...
  <body>
     	<nav class="navbar-nav navbar-expand-sm bg-info" style="margin:0px;padding:0px; color: #fff;">
            ...
            <div class="nav-item item1" style="margin-left:5%">                   
                <h3  style="float:left;cursor:pointer;margin:10px 2px 0px 20px;">LIBRARY MANAGEMENT SYSTEM | Student </h3>                                   
            </div>
            <div style="width:50%" >
            ...
            <!-- Links -->
                <ul class="navbar-nav" style="width:100%;">
                    ...
                    <li class="nav-item"  id="p_comp" style="display:none;border-top:1.2px solid white;">
                        <a class="btn btn-dark btn1" onclick="pending()" href="viewthebooks.php">View the available books</a>
                    </li>
                    <li class="nav-item" id="ccomp" style="display:none;">
                        <a class="btn btn-dark btn1" onclick="complcomp()"href="bookabook.php">Book a book</a>
                    </li>    
                </ul>
        </nav>	
        <div id="main" class="container" style="position:relative;">
          <div id="forum" style="width:80%;margin-left:8%;background:white;margin-top:25px;float:left; border:1px solid #f4f8f8;border-radius:10px;box-shadow:2px 3px 5px 2px;">
            <form name="form" action="login7.php" onsubmit="return isvalid()" method="POST"> 
                <div style="margin:0%;">
                <h1 style="text-align:center;border-bottom:2px solid #f0f5f1;padding:12px;border-radius:2px;">Borrow a book</h1>
                </div>
                  <div><marquee style="color:red"><h2>Be Cautious while entering the bookname</h2></marquee></div>
                  <div style="margin:5%">
                       <lable>Roll Number</label>
                       <input type="text" id="user" name="user" required placeholder="Enter borrower roll number" class="form-control" > 
                  </div>
                  <div style="margin:5%"> 
                      <lable>Book Name</lable>
                      <input type="text" id="pass" name="pass"  required placeholder="Enter the book name" class="form-control" > 
                  </div>
                  <div style="margin:5%"> 
                      <lable>Borrowing date</lable>
                      <input type="des" id="des" name="des" required placeholder="Enter the date in dd-mm-yyyy format " class="form-control" > 
                  </div>
                  <div>
