  ...
  <body>
        ...
        <div id="main" class="container" style="position:relative;">
          <div id="forum" style="width:80%;margin-left:8%;background:white;margin-top:25px;float:left; border:1px solid #f4f8f8;border-radius:10px;box-shadow:2px 3px 5px 2px;">
            <form name="form" action="login6.php" onsubmit="return isvalid()" method="POST"> 
                <div style="margin:0%;">
                <h1 style="text-align:center;border-bottom:2px solid #f0f5f1;padding:12px;border-radius:2px;">View available books</h1>
                </div>
                  <div>
                       <input type="submit" id="btn" value="View" name = "submit" class="btn btn-primary" style="padding-left:30%;padding-right:30%;margin-left:20%;">
					</div>               
            </form>
