  ...
  <body>
        ...
        <div id="main" class="container" style="position:relative;">
          <div id="forum" style="width:80%;margin-left:8%;background:white;margin-top:25px;float:left; border:1px solid #f4f8f8;border-radius:10px;box-shadow:2px 3px 5px 2px;">
            <form name="form" action="login3.php" onsubmit="return isvalid()" method="POST"> 
                <div style="margin:0%;">
                <h1 style="text-align:center;border-bottom:2px solid #f0f5f1;padding:12px;border-radius:2px;">Add a book</h1>
                </div>
                  <div style="margin:5%">
                       <lable>Book Name</lable>
                       <input type="text" id="user" name="user" required placeholder="Enter the book name" class="form-control" > 
                  </div>
                  <div style="margin:5%"> 
                      <lable>Author name</lable>
                      <input type="text" id="pass" name="pass"  required placeholder="Give the author name" class="form-control" > 
                  </div>
                  <div style="margin:5%"> 
                      <lable>Books Description</lable>
                      <input type="des" id="des" name="des" required placeholder="Give some description about the book" class="form-control" > 
                  </div>
                  <div>
