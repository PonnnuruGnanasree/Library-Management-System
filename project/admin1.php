  ...
  <body>
        ...
        <nav class="navbar-nav navbar-expand-sm bg-dark">
                <div class="nav-item item1" style="margin-left:5%">
                    <h2 onclick='window.location.open("index.html");' style="cursor:pointer">  LIBRARY MANAGEEMENT SYSTEM</h2>
                </div>
		...
		<div id="forum" style="width:80%;margin-left:8%;background:white;margin-top:25px;float:left; border:1px solid #f4f8f8;border-radius:10px;box-shadow:2px 3px 5px 2px;">
			<form name="form" action="login.php" onsubmit="return isvalid()" method="POST"> 
					...
					<div style="margin:5%">
					<h4>Your Name
				<input type="text" required id="user" name="user" placeholder="Enter your name" class="form-control">
				Password
				<input type="password" id="pass" required name="pass" placeholder="Enter your Password" class="form-control"></h4>
